export const problem: IProblem.item[] = [
  ...
  },
  {
    ...
    "answer": "<meta name=\"viewport\" content=\"initial-scale=1,maximum-scale=1, minimum-scale=1\">\nrem, vw\n"
  },
  {
    "id": 6,
    ...
    "answer": "1、link是HTML标签，@import是css提供的\n2、link引入的样式页面加载时同时加载，@import引入的样式需等页面加载完成后再加载\n3、link没有兼容性问题，@import不兼容ie5以下\n4、link可以通过js操作DOM动态引入样式表改变样式，而 @import不可以\n"
  },
  {
    "id": 7,
  ...
  },
  {
    ...
    "answer": "1、直接在子组件中通过 this.$parent.event 来调用父组件的方法\n\n2、在子组件里用 $emit 向父组件触发一个事件，父组件监听这个事件\n\n3、父组件把方法传入子组件中，在子组件里直接调用这个方法\n"
  },
  {
    "id": 14,
  ...
  },
  {
    ...
    "answer": "event.currentTarget 指向事件所绑定的元素\n\nevent.target 始终指向事件发生时的元素\n"
  },
  {
    "id": 17,
  ...
  },
  {
    ...
    "answer": "this.$emit(\"eventName\",data)\ndata为一个对象\n"
  },
  {
    "id": 20,
    ...
    "answer": "多级组件嵌套需要传递数据时，通常使用的方法是通过vuex。如果为了传递数据而无中间层处理，则可以使用Vue中提供的$attrs和$listeners\n"
  },
  {
    "id": 21,
    ...
    "answer": "v-model 默认的触发条件是 input 事件, 加了 .lazy 修饰符之后, v-model 会在 change 事件触发的时候去监听\n"
  },
  {
    "id": 22,
  ...
  },
  {
    ...
    "answer": "当前注册一个vue组件定义 name 为 \"node-tree\" ，在组件 template 内部 <node-tree></node-tree>\n"
  },
  {
    "id": 24,
  ...
  },
  {
    ...
    "answer": "VUE2: 通过 Object.defineProperty 去监听对象的每一个属性，然后在 get , set 方法中通过发布订阅者模式来实现的数据响应，但是存在一定的缺陷，比如只能监听已存在的属性，对于新增删除属性就无能为力了，同时无法监听数组和对象的变化\n\nVue3: 是采用数据劫持结合发布者-订阅者模式的方式，通过 new Proxy() 来劫持各个属性的 setter ， getter ，在数据变动时发布消息给订阅者，触发相应的监听回调\n"
  },
  {
    "id": 26,
    ...
    "answer": "1、对与一次获取全部数据时可使用 Object.freeze\n\n2、分也加载或者分页渲染\n\n3、虚拟滚动\n"
  },
  {
    "id": 27,
    ...
    "answer": "template作用：当做一个不可见的包裹元素，不显示在页面中，减少了不必要的dom元素\n\n常见场景：解决v-for、v-if等一起使用问题\n"
  },
  {
    "id": 28,
  ...
  },
  {
    ...
    "answer": "项目使用 keep-alive 时，可搭配组件 name 进行缓存过滤\n\n递归组件时需要调用自身 name\n\nvue-devtools 调试工具里显示的组见名称是由组件 name 决定的\n"
  },
  {
    "id": 31,
    "title": "SSR 解决了什么问题",
  ...
  },
  {
    ...
    "answer": "对象为引用类型，当重用组件时，由于数据对象都指向同一个 data 对象，当在一个组件中修改 data 时，其他重用的组件中的 data 会同时被修改；而使用返回对象的函数，由于每次返回的都是一个新对象（Object的实例），引用地址不同，则不会出现这个问题\n"
  },
  {
    "id": 42,
  ...
  },
  {
    ...
    "answer": "性能优化 diff 时更快更准确找到变化的位置\n"
  },
  {
    "id": 44,
    ...
    "answer": "v-if 不渲染 DOM，v-show 会渲染 DOM\n"
  },
  {
    "id": 45,
  ...
  },
  {
    ...
    "answer": "!新增选择器 document.querySelector、document.querySelectorAll\n拖拽释放(Drag and drop) API\n媒体播放的 video 和 audio\n本地存储 localStorage 和 sessionStorage\n离线应用 manifest\n桌面通知 Notifications\n语意化标签 article、footer、header、nav、section\n增强表单控件 calendar、date、time、email、url、search\n地理位置 Geolocation\n多任务 webworker\n全双工通信协议 websocket\n历史管理 history\n跨域资源共享(CORS) Access-Control-Allow-Origin\n页面可见性改变事件 visibilitychange\n跨窗口通信 PostMessage\nForm Data 对象\n绘画 canvas\n"
  },
  {
    "id": 49,
    "title": "伪类和伪元素",
  ...
  },
  {
    ...
    "answer": "易于用户阅读，样式丢失的时候能让页面呈现清晰的结构\n\n有利于SEO，搜索引擎根据标签来确定上下文和各个关键字的权重\n\n方便屏幕阅读器解析，如盲人阅读器根据语义渲染网页\n\n有利于开发和维护，语义化更具可读性，代码更好维护，与CSS3关系更和谐\n"
  },
  {
    "id": 52,
    "title": "let const var",
  ...
  },
  {
    ...
    "answer": "微信小程序是双线程架构，分为逻辑层和渲染层，在进行文件解析的时候不会发生阻塞\n"
  },
  {
    "id": 75,
    ...
    "answer": "相同点：首先他们都是作为点击事件函数，就是点击时触发\n\n不同点：bindtap不会阻止冒泡，catchtap是阻止冒泡的\n"
  },
  {
    "id": 76,
    "title": "微信小程序的优劣势",
  ...
  },
  {
    ...
    "answer": "虚拟 dom 相当于在 js 和真实 dom 中间加了一个缓存，利用 dom diff 算法避免了没有必要的 dom 操作，从而 提高性能\n"
  },
  {
    "id": 78,
    "title": "React组件间通信",
  ...
  },
  {
    ...
    "answer": "Promise的出现解决了传统callback函数导致的“地域回调”问题，但它的语法导致了它向纵向发展行成了一个回调链，遇到复杂的业务场景，这样的语法显然也是不美观的。而async await代码看起来会简洁些，使得异步代码看起来像同步代码，await的本质是可以提供等同于”同步效果“的等待异步返回能力的语法糖，只有这一句代码执行完，才会执行下一句\n\nasync await与Promise一样，是非阻塞的\nasync await是基于Promise实现的，可以说是改良版的Promise，它不能用于普通的回调函数\npromise是一个对象，async是一个函数\npromise属于ES6，async属于es7\npromise处理异步是另一种地狱回调，async是测底拉平，更加优雅好用\npromise是async的底层\n"
  },
  {
    "id": 88,
    "title": "promise的理解",
  ...
  },
  {
    ...
    "answer": "在代码块内，使用let和const命令声明变量之前，该变量都是不可用的，语法上被称为暂时性死区\n\n暂时性死区的本质就是，只要一进入当前作用域，所要使用的变量就已经存在了，但是不可获取，只有等到声明变量的那一行代码出现，才可以获取和使用该变量\n"
  },
  {
    "id": 94,
    "title": "防抖和节流？应用场景？",
    ...
    "answer": "防抖和节流：优化高频率执行js代码的一种手段，js中的一些事件如浏览器的resize、scroll，鼠标的mousemove、mouseover，input输入框的keypress等事件在触发时，会不断地调用绑定在事件上的回调函数，极大地浪费资源，降低前端性能。为了优化体验，需要对这类事件进行调用次数的限制\n\n防抖：\n在事件被触发n秒后再执行回调，如果在这n秒内又被触发，则重新计时\n应用场景：搜索框搜索输入、窗口大小Resize\n\n节流：\n每隔一段时间，只执行一次函数\n应用场景：滚动加载、高频点击提交\n"
  },
  {
    "id": 95,
    "title": "浅拷贝与深拷贝",
    ...
    "answer": "浅拷贝只复制对象的第一层属性、深拷贝可以对对象的属性进行递归复制\n"
  },
  {
    "id": 96,
  ...
  },
  {
    ...
    "answer": "CSS 属性 mask 允许使用者通过遮罩或者裁切特定区域的图片的方式来隐藏一个元素的部分或者全部可见区域\n\n详见：https://developer.mozilla.org/zh-CN/docs/Web/CSS/mask\n"
  },
  {
    "id": 100,
    "title": "css使一个元素多背景叠加",
  ...
  },
  {
    ...
    "answer": "子元素的float、clear和vertical-align属性将失效\n"
  },
  {
    "id": 102,
    "title": "flex是哪些属性的简写",
  ...
  },
  {
    ...
    "answer": "!important >内联 > ID选择器 > 类选择器 > 标签选择器\n"
  },
  {
    "id": 106,
  ...
  },
  {
    ...
    "answer": "typeof的返回值是一个字符串，用来说明变量的数据类型（null ,Array、Object 结果都是Object）；instanceof的返回值是布尔值，用于判断一个变量是否属于某个对象的实例\n"
  },
  {
    "id": 112,
    "title": "说说你对闭包的理解",
    ...
    "answer": "闭包就是可以访问其他函数内部变量的函数，我们通常用它来定义私有化的变量和方法，创建一个闭包最简单的方法就是在一个函数内创建一个函数，它有三个特性是 函数内可以再嵌套函数，内部函数可以访问外部的方法和变量，方法和变量不会被垃圾回收机制回收\n优点\n变量长期在内存中\n可重复的使用变量，不会污染\n\n缺点\n内存消耗大，不能滥用，否则会造成性能问题，解决方法：退出函数时，将局部变量删除\n"
  },
  {
    "id": 113,
    "title": "闭包使用场景",
  ...
  },
  {
    ...
    "answer": "window、location、navigator 、screen、history\n"
  },
  {
    "id": 115,
    "title": "js判断一个数组",
  ...
  },
  {
    ...
    "answer": "事件代理（Event Delegation），又称之为事件委托。是JavaScript中常用绑定事件的常用技巧。顾名思义，“事件代理”即是把原本需要绑定在子元素的响应事件（click、keydown......）委托给父元素，让父元素担当事件监听的职务。事件代理的原理是DOM元素的事件冒泡\n"
  },
  {
    "id": 118,
    "title": "冒泡与捕获的区别",
  ...
  },
  {
    ...
    "answer": "bundle：是由webpack打包出来的文件\nchunk：是一个代码块，一个chunk由多个模块组合而成\nmodule：是开发中的单个模块\n"
  },
  {
    "id": 120,
  ...
  },
  {
    ...
    "answer": "setState第一个参数可以是一个对象，或者是一个函数，而第二个参数是一个回调函数，用于可以实时的获取到更新之后的数据\n\n在使用setState更新数据的时候，setState的更新类型分成：同步更新，异步更新\n\n在组件生命周期或React合成事件中，setState是异步\n\n在setTimeout或者原生dom事件中，setState是同步\n\n对同一个值进行多次 setState， setState 的批量更新策略会对其进行覆盖，取最后一次的执行结果\n"
  },
  {
    "id": 126,
  ...
  },
  {
    ...
    "answer": "TypeScript是JavaScript的类型的超集，支持ES6语法，支持面向对象编程的概念，其是一种静态类型检查的语言，提供了类型注解，在代码编译阶段就可以检查出数据类型的错误，TypeScript在编译阶段需要编译成JavaScript来运行\n\njs 脚步语言，ts面向对象编程语言\njs学习难度小，ts相对js学习难度高\njs轻量级解释编辑语言，ts强类型面向对象编程语言\njs更灵活\njs人气更高，很方便地找到大量成熟的开发项目和可用资源\nts代码质量更好、更清晰\nts可以在开发人员编写脚本时检测错误\nts进行重构更变的容易、快捷\n"
  },
  {
    "id": 130,
    "title": "React如何获取表单数据",
    ...
    "answer": "1.给文本框value属性绑定state中定义的变量,配合onChange事件修改state\n2.给文本框添加ref,表单提交时或获取ref的value\n"
  },
  {
    "id": 131,
    "title": "受控组件和非受控组件",
  ...
  },
  {
    ...
    "answer": "HTML 经过解析生成 DOM树； CSS经过解析生成　Style Rules。 二者一结合生成了Render Tree。 通过layout计算出DOM要显示的宽高、位置、颜色。 最后渲染在界面上\n"
  },
  {
    "id": 137,
    "title": "为什么换工作",
  ...
  },
  {
    ...
    "answer": "本地当前分支上，修改冲突代码--->add--->commit--->push\n"
  },
  {
    "id": 142,
    "title": "高阶组件的理解与应用场景",
  ...
  },
  {
    ...
    "answer": "WXSS 具有 CSS 大部分特性。同时为了更适合开发微信小程序，WXSS 对 CSS 进行了扩充以及修改\n1.尺寸单位 rpx\n2.提供了全局的样式和局部样式\n3.WXSS 仅支持部分 CSS 选择器\n"
  },
  {
    "id": 144,
  ...
  },
  {
    ...
    "answer": "柯里化函数：把一个多参数的函数转化为单参数函数的方法。并且返回接受余下的参数而且返回结果的新函数的技术\n"
  },
  {
    "id": 160,
    "title": "宏任务和微任务",
    ...
    "answer": "js中的一个机制，就是遇到宏任务，先将宏任务放入eventqueue，然后在执行微任务\n\n宏任务：setTimeout, setInterval, Ajax, DOM事件\n\n微任务：Promise async/await\n"
  },
  {
    "id": 161,
  ...
  },
  {
    ...
    "answer": "使用 babel-polyfill 插件,和前缀名 hack\n"
  },
  {
    "id": 165,
    "title": "Vue中使用了哪些设计模式",
  ...
  },
  {
    ...
    "answer": "修改状态只能是mutations，actions只能通过提交mutation修改状态\n"
  },
  {
    "id": 177,
  ...
  },
  {
    ...
    "answer": "Context 通过组件树提供了一个传递数据的方法，从而避免了在每一个层级手动的传递 props 属性\n"
  },
  {
    "id": 180,
    ...
    "answer": "import PropTypes from \"prop-types\"\n"
  },
  {
    "id": 181,
    ...
    "answer": "构造函数和getInitialState之间的区别就是ES6和ES5本身的区别。在使用ES6类时，应该在构造函数中初始化state，并在使用React.createClass时定义getInitialState方法\n"
  },
  {
    "id": 182,
  ...
  },
  {
    ...
    "answer": "Js代码分为同步，异步代码。宏观任务和微观任务。js是单线程的，在主线程里面在执行代码的时候按照顺序最先执行同步代码，在执行的过程中发现有异步代码（回调函数）则会把异步代码放在任务队列中（消息队列）。在执行了所有的主线程里的同步代码以后，异步代码会放在主线程里面最后执行\n"
  },
  {
    "id": 185,
    "title": "js声明变量的六种方法是什？",
    ...
    "answer": "ES5: var 、function； ES6:  let、const、import、class \n"
  },
  {
    "id": 186,
  ...
  },
  {
    ...
    "answer": "title表示，当图片正常显示时，鼠标悬浮在图片时显示的文字，alt表示，图片无法正常显示时，展示的文字\n"
  }
]
